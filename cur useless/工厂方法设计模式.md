...
![](https://refactoringguru.cn/images/patterns/content/factory-method/factory-method-zh.png?id=eb7978e462e88f2ef03aec83d7510389)
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/problem1-zh.png?id=f5c316dc94303f8562f2b3d48008ee8b)
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/solution1.png?id=fc756d2af296b5b4d482e548214d08ef)
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/solution2-zh.png?id=fe0e663d7c2c9ec059c27b0bd531a7cc)
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/solution3-zh.png?id=9c410cba8016db64975735bfbd4b5b28)
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/structure.png?id=4cba0803f42517cfe8548c9bc7dc4c9b)![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/structure-indexed.png?id=4c603207859ca1f939b17b60a3a2e9e0)
...
@media (min-width: 1200px) { .structure { margin: 0; width: auto; height: 600px; } .struct-image1 { left: 170px; top: 30px; } .struct-li1 { left: 580px; top: 10px; width: 250px; } .struct-li2 { left: 600px; top: 330px; width: 220px; } .struct-li3 { left: 0px; top: 0px; width: 170px; } .struct-li4 { left: 190px; top: 420px; width: 390px; } }
...
![](https://refactoringguru.cn/images/patterns/diagrams/factory-method/example.png?id=67db9a5cb817913444efcb1c067c9835)
...
你可以使用此方法开发其他 UI 组件。 不过， 每向对话框中添加一个新的工厂方法， 你就离[抽象工厂](/design-patterns/abstract-factory)模式更近一步。 我们将在稍后谈到这个模式。
...
*   你可以同时使用[工厂方法](/design-patterns/factory-method)和[迭代器模式](/design-patterns/iterator)来让子类集合返回不同类型的迭代器， 并使得迭代器与集合相匹配。
...
*   [工厂方法](/design-patterns/factory-method)是[模板方法模式](/design-patterns/template-method)的一种特殊形式。 同时， _工厂方法_可以作为一个大型_模板方法_中的一个步骤。